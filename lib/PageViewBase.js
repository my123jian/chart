...
PageViewBase.prototype.addMarker = function (name, lng, lat) {
    ...
    var content = '<div class="marker-route marker-marker-point"></div><div class="infowindow" style="color:#ddf3ff">' +
        '<div class="first">实时客流</div><div class="second">11111.3万</div></div><div style="text-align: center;color: #ddf3ff;    margin-left: -52px;\n' +
        '    width: 198px;\n' +
...
PageViewBase.prototype.addMarker2 = function (name, lng, lat) {
    this.markers = this.markers || {};
    if (this.markers[name]) {
        return this.markers[name];
    }
    ...
    var content = '<div class="infowindow" style="color:#ddf3ff">' +
        '<div class="first">实时客流</div><div class="second">11111.3万</div></div><div class="marker-route marker-marker-point"></div><div style="text-align: center;color: #ddf3ff;    margin-left: -52px;\n' +
        '    width: 198px;\n' +
        '    display: inline-block;font-size: 24px;\n' +
        '    margin-top: 5px;">'+name+'</div>';
