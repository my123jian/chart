...
12小时风速 WIND_SPEED_12
        * */
        ...
        $(theFields[1]).text(theItem['MIN_TEMP_24'] || '暂无');
        $(theFields[2]).text(theItem['WEATHER_TYPE_12'] || '暂无');
        $(theFields[3]).text(theItem['WIND_DIRECTION_12'] || '暂无');
        $(theFields[4]).text(theItem['WIND_SPEED_12'] || '暂无');
        theIndex += 1;
        //debugger;
    })
