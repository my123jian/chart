$(function () {
    ...
    var theTempalte = "<div class=\"huan-chart-text\">\n" +
        ...
        "                            </div>\n" +
        "                            <svg id='svgcanvs' style=\"z-index: 100;margin-left: 4px;\" xmlns=\"http://www.w3.org/2000/svg\" version=\"1.1\" height=\"100\" width=\"100\">\n" +
        "                                <defs>\n" +
        ...
        "                                </defs>\n" +
        "\n" +
        "                                <path id='base-path' d=\"\" stroke=\"#3964a5\"\n" +
        "                                      stroke-linecap=\"round\"\n" +
        "                                      stroke-width=\"10\" fill=\"none\" />\n" +
        "\n" +
        "                                <path id='per-path' d=\"\" stroke=\"#faeebe\"\n" +
        "                                      marker-end=\"url(#dot)\"\n" +
        "                                      stroke-width=\"10\" fill=\"none\" />\n" +
        "\n" +
        "                            </svg>";
    ...
    function ChartHuan(ele, id) {
        ...
        */
        ...
        var theR=theData['r']||100;
        var theSvg=$(theTemplateEle[2]);//.find('#svgcanvs');
        $(theSvg).attr('width',theR);
        $(theSvg).attr('height',theR);
        //debugger;
        if (theData.bg) {
       ...
       // this.dotId = 'dot' + theData.color;
        ...
        var thePath = describeArc(theR/2, theR/2, theR/2-5, 0, 360 - 60);
    ...
    ChartHuan.prototype.refresh = function (name, value) {
        ...
        var thePath = describeArc(theR/2, theR/2, theR/2-5, 0, value * 3);
