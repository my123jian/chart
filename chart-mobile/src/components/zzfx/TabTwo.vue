...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            loadMigrateAge() {
                //迁徙人群画像分析-年龄
                var theUrl1 = "/citytransport/regionAge";
                //近期热门迁徙路线
            ...
            loadMigrateSex() {
                var me = this;
                //迁徙人群画像分析-年龄
                var theUrl1 = "/citytransport/regionSex";
                //近期热门迁徙路线
                var theUrl = window.baseUrl + theUrl1;
                var theQueryObj = {
                    dateTime: this.queryDate.formateYearMonth(),
            ...
            loadMigrateNativePlace() {
                //迁徙人群画像分析-年龄
                var me=this;
                var theUrl1 = "/citytransport/regionNativePlace";
                //近期热门迁徙路线
                var theUrl = window.baseUrl + theUrl1;
                var theQueryObj = {
                    dateTime: this.queryDate.formateYearMonth(),
            ...
            loadMigrateHobby() {
                //迁徙人群画像分析-年龄
                var me = this;
                var theUrl1 = "/citytransport/regionHobby";
                //近期热门迁徙路线
                var theUrl = window.baseUrl + theUrl1;
                var theQueryObj = {
                    dateTime: this.queryDate.formateYearMonth(),
            ...
            loadMigrateconsume() {
                //迁徙人群画像分析-年龄
                var theUrl1 = "/citytransport/regionConsume";
                //近期热门迁徙路线
                var theUrl = window.baseUrl + theUrl1;
                var theQueryObj = {
                    dateTime: this.queryDate.formateYearMonth(),
