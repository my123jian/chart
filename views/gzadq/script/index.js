$(function () {
    ...
    PageViewModel.prototype.initEvent = function () {
        ...
        //    $('.tab-main .tab-item').addClass('select_a');
        //    $(this).removeClass('select_a');
    ...
    PageViewModel.prototype.initChartGdMap = function () {
        if (!this.ChartMap) {
    ...
    PageViewModel.prototype.loadChart3 = function (xData, data1, data2) {
        ...
        theCurrentOption.series = [
            ...
            },
            {
                ...
                smooth: true,
                //stack: '总量',
                data: data2||[155, 222, 333, 155, 177, 122, 222]
            }
        ];
